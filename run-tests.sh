...
python3 - <<'PYCHECK'
import pathlib, sys
required = ['adapters/claude-code/INSTALL.md', 'adapters/codex/INSTALL.md', 'adapters/opencode/INSTALL.md', 'examples/binutils/package-profile.example.json', 'examples/binutils/candidate.example.md', 'examples/binutils/hypothesis.example.json', 'examples/binutils/validation-result.example.md', 'examples/binutils/finding.example.md', 'examples/generic/internal-report.example.md', 'examples/binutils/run-binutils-audit.sh', 'examples/binutils/README.md', 'references/binutils-validation.md', 'references/context-budget-policy.md', 'references/tool-installation-policy.md', 'references/cvss31-scoring-guide.md', 'templates/tool-install-plan.md', 'docs/runbooks/tool-availability-advisor.md', 'docs/runbooks/binutils-real-source.md', 'docs/runbooks/install-and-migration.md', 'docs/runbooks/context-budget-guard.md', 'install/install.sh', 'install/verify-install.sh', 'RELEASE-NOTES-0.6.0-alpha6.md', 'RELEASE-NOTES-0.7.0-alpha7.md', 'RELEASE-NOTES-0.8.0-alpha8.md', 'schemas/bilingual-output.schema.json', 'schemas/public-vuln-record.schema.json', 'schemas/public-vuln-correlation.schema.json', 'schemas/openeuler-vuln-registry.schema.json', 'schemas/poc-testcase.schema.json', 'references/bilingual-output-policy.md', 'references/public-vulnerability-correlation-policy.md', 'references/poc-reproducer-policy.md', 'docs/runbooks/bilingual-output.md', 'docs/runbooks/public-vulnerability-correlation.md', 'docs/runbooks/validated-poc-testcases.md', 'templates/zh-CN/finding.md', 'templates/en-US/finding.md', 'offline-bundle/vuln-db/manifest.example.json', 'offline-bundle/vuln-db/openeuler/manifest.json', 'offline-bundle/vuln-db/openeuler/README.md', 'RELEASE-NOTES-0.9.0-alpha9.md', 'CHANGELOG.md', 'LICENSE']
