...
def sample_findings():
    return {'findings':[{'id':'FINDING-001','status':'Validated','summary':'buffer overflow in parser','affected_component':{'package':'demo','component':'parser'},'source_code_evidence':[]}]} 
